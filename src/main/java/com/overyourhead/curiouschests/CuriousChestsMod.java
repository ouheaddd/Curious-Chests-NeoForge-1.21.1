...
public final class CuriousChestsMod {
    ...
    public CuriousChestsMod(IEventBus modBus) {
        ...
        NeoForge.EVENT_BUS.addListener(WitchChestEvents::onRightClickBlock);
        NeoForge.EVENT_BUS.addListener(TrapperEvents::onBreak);
        NeoForge.EVENT_BUS.addListener(TrapperEvents::onDrops);
    }
}
